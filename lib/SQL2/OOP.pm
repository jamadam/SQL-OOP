...
### ---
### 識別子パーツのドット連結クラス("public"."table"."colmun1"."...")を定義
### ---
package SQL::OOP::ID;
use strict;
use warnings;
...
Here is a complehensive example for SELECT. You also can see many examples in
test scripts.
