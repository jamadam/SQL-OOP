...
All new constructors, append methods and set methods are capable of code refs
for arguments instead of string or objects so that you can encapsulate
temporary things inside of it.
